...
const features = [
  {
    ...
    icon: <Presentation className="w-10 h-10 icon-glow-primary" />,
  ...
  },
  {
    ...
    href: '/scene-preview',
    icon: <Clapperboard className="w-10 h-10 icon-glow-accent" />,
  ...
  },
  {
    ...
    href: '/ppt-enhancer',
    icon: <Wand2 className="w-10 h-10 icon-glow-primary" />,
    textColor: 'text-glow-primary',
  },
  {
    ...
    icon: <Sparkles className="w-10 h-10 icon-glow-accent" />,
    textColor: 'text-glow-accent',
  },
  {
    ...
    href: '/creative-spark',
    icon: <Lightbulb className="w-10 h-10 icon-glow-primary" />,
    textColor: 'text-glow-primary',
  },
  {
    ...
    href: '/text-to-speech',
    icon: <AudioLines className="w-10 h-10 icon-glow-accent" />,
    textColor: 'text-glow-accent',
  },
];
