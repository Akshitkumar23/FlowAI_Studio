                  ...
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="font-semibold">Visual Style</FormLabel>
                           ...
                           <div key={index} className="relative">
                            {preview ? (
                                <div className="relative h-16 w-16">
                                    <Image src={preview} alt={`Reference ${index + 1}`} layout="fill" objectFit="cover" className="rounded-lg border-2 border-primary" />
                                    <Button
                                        type="button"
                                        variant="destructive"
                                        size="icon"
                    ...
                    >
                      <CardContent className="p-0">
                        <div className="aspect-video relative">
                          <Image src={imgSrc} alt={`Generated scene ${index + 1}`} layout="fill" objectFit="cover" />
