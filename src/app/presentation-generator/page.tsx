...
export default function PresentationGeneratorPage() {
  ...
  const PreviewSlides = useCallback(() => {
    ...
    return (
        <div ref={previewCardRef} className="w-full flex justify-center p-4">
            <div 
  ...
  }, [slides, logoPreview, titleBgPreview, scale, form.watch()]);
  ...
  return (
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto items-start">
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <Collapsible>
                            ...
                            <CollapsibleContent className="space-y-4 pt-4 animate-accordion-down">
                                ...
                                <Collapsible>
                                    <CollapsibleTrigger asChild>
                                        <Button variant="ghost" className="p-0 h-auto text-sm text-muted-foreground w-full justify-start gap-2">
        ...
        <div className="space-y-8">
            {isLoading && (
            <Card className="flex items-center justify-center h-96 bg-background/50">
                ...
                <Card className="bg-background/50">
                 ...
                 <Card className="bg-background/50">
                    ...
                    <CardContent className="flex justify-center items-center gap-4">
                        <Button onClick={() => setShowInlinePreview(!showInlinePreview)} disabled={isLoading || isRevising || slides.length === 0}>
                            <Eye className="mr-2 h-4 w-4" />
                            {showInlinePreview ? 'Hide Preview' : 'Show Live Preview'}
                        </Button>
                         <Button onClick={generateAndDownloadPdf} disabled={isProcessingPdf || slides.length === 0}>
                            {isProcessingPdf ? (
