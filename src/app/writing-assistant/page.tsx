...
import { Loader2, Sparkles, Bot, Copy, Check, Save } from "lucide-react";
                ...
                <div className="max-w-2xl mx-auto">
                    <Tabs defaultValue={tools[0].name} className="w-full">
                        <TabsList className={cn(
                            ...
                            "bg-background/50 border border-white/10 p-2 rounded-xl"
                        )}>
                            {tools.map(tool => (
                                <TabsTrigger 
                                    key={tool.name} 
                        ...
                        {tools.map(tool => (
                             <TabsContent key={tool.name} value={tool.name}>
                                <Card className="glass">
                                    <CardHeader>
                                        <CardTitle>{tool.name === 'Product Desc.' ? 'Product Description' : tool.name}</CardTitle>
                                        {tool.name === 'Profile' && <CardDescription>This data is saved in your browser to pre-fill other tools and personalize results.</CardDescription>}
                                    </CardHeader>
                                    <CardContent>
                                        {tool.component}
                                    </CardContent>
