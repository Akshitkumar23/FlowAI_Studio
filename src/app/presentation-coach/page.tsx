...
import { presentationCoach, PresentationCoachOutput } from "@/ai/flows/presentation-coach-flow";
...
export default function PresentationCoachPage() {
    ...
    const [result, setResult] = useState<PresentationCoachOutput | null>(null);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await presentationCoach({ slides, script: scriptText });
            setResult(response);
        } catch (err) {
            console.error("Error getting presentation feedback:", err);
                    ...
                    {isLoading && (
                         <Card className="glass flex items-center justify-center h-full">
                            <div className="text-center p-8">
                                ...
                                <p className="mt-4 text-lg text-muted-foreground">Your AI Coach is reviewing your presentation...</p>
