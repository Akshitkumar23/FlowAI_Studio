...
const analyzeImageStylePrompt = ai.definePrompt({
  ...
  prompt: `You are an expert art critic. Please analyze the style of the image provided and generate a text prompt that describes the style.
...
const enhancePromptTemplate = ai.definePrompt({
    ...
    A user will provide a simple prompt. Your task is to expand it into a more detailed and effective prompt.
